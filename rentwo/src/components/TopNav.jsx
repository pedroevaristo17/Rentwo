      ...
      <div className="mx-auto max-w-[1100px] px-4 lg:px-8 py-3 flex items-center gap-4">
        ...
        <nav className="flex flex-1 justify-end flex-wrap gap-x-6 gap-y-2 items-center">
          ...
          <div className="flex items-center gap-2 border-l border-slate-200 pl-4">
            ...
            <div
              className="hidden sm:block bg-center bg-no-repeat bg-cover rounded-full size-10 border-2 border-primary/20"
              style={{
                backgroundImage: `url(${
                  state.profile.avatarUrl || "https://i.pravatar.cc/200?img=11"
                })`,
              }}
            />
          </div>
